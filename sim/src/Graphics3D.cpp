...
void Graphics3D::_DrawContactForce() {
  ...
  Vec3<float> Pos9, Pos11, Pos13, Pos15;				
  Vec3<float> Force9, Force11, Force13, Force15;
  for (size_t i(0); i<3; i++){						
    Pos9(i)=0.0;
    Pos11(i)=0.0;
    Pos13(i)=0.0;
  ...
  Vec3<float> Dist_9_11, Dist_9_13, Dist_15_11, Dist_13_15, Dist_11_13, Dist_9_15;        
  ...
  for (size_t i(0); i < _drawList.getTotalNumGC(); ++i) {
    ...
    if(i==11){
       Pos11 = floatPos;
       Force11 = floatForce;
       Dist_9_11(0)=Pos9(0)-Pos11(0);               
       Dist_9_11(1)=Pos9(1)-Pos11(1);
       Dist_9_11(2)=Pos9(2)-Pos11(2);
    }
    if(i==13){
       Pos13 = floatPos;
       Force13 = floatForce;
       Dist_9_13(0)=Pos9(0)-Pos13(0);
       Dist_9_13(1)=Pos9(1)-Pos13(1);
       Dist_9_13(2)=Pos9(2)-Pos13(2);

       Dist_11_13(0)=Pos11(0)-Pos13(0);
       Dist_11_13(1)=Pos11(1)-Pos13(1);
       Dist_11_13(2)=Pos11(2)-Pos13(2);
    }
    if(i==15){
       Pos15 = floatPos;
       Force15 = floatForce;
       
       Dist_13_15(0)=Pos15(0)-Pos13(0);
       Dist_13_15(1)=Pos15(1)-Pos13(1);
       Dist_13_15(2)=Pos15(2)-Pos13(2);

       Dist_15_11(0)=Pos15(0)-Pos11(0);
       Dist_15_11(1)=Pos15(1)-Pos11(1);
       Dist_15_11(2)=Pos15(2)-Pos11(2);
       
       Dist_9_15(0)=Pos9(0)-Pos15(0);
       Dist_9_15(1)=Pos9(1)-Pos15(1);
       Dist_9_15(2)=Pos9(2)-Pos15(2);
    }
    if(Force9(2)!=0.0){						//Support Polygon
      if(Force11(2)!=0.0){
         _drawArrow(Pos11, Dist_9_11, .005, .001, .001);
      }
      if(Force13(2)!=0.0){
         _drawArrow(Pos13, Dist_9_13, .005, .001, .001);
      }
      if(Force15(2)!=0.0){
         _drawArrow(Pos15, Dist_9_15, .005, .001, .001);
      }
    }
    if(Force15(2)!=0.0){
      if(Force11(2)!=0.0){
         _drawArrow(Pos11, Dist_15_11, .005, .001, .001);
      }
      if(Force13(2)!=0.0){
         _drawArrow(Pos13, Dist_13_15, .005, .001, .001);
      }
    }
    if(Force11(2)!=0.0 && Force13(2)!=0.0){
       _drawArrow(Pos13, Dist_11_13, .005, .001, .001);
    }
  }
  glPopAttrib();
  glDisable(GL_BLEND);
