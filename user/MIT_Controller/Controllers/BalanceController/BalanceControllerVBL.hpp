...
void saveData(std::string fileaNme,Eigen::Matrix<fpt,Dynamic,Dynamic> matrix);
...
class BalanceControllerVBL
{
   public:
     ...
     void updateProblemData(   double* xfb_in,
      ...
      void solveQP_nonThreaded(double* xOpt,double* xOptPrev);

      bool firstRunVBL = true;
      ...
      void calc_linear_error(double* rpy_des_real);  
      //void calc_linear_error();
      Eigen::VectorXd s_LQR;
      Eigen::VectorXd err_state;
   ...
   private:
      ...
      Eigen::VectorXd omega_b_body_desired_real; 
      Eigen::VectorXd omegadot_b_world_desired;      
      Eigen::MatrixXd R_b_world_desired;
      Eigen::MatrixXd R_b_world_desired_real;
