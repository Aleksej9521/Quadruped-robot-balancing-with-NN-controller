...
public:
  MIT_UserParameters()
	...
	INIT_PARAMETER(use_twolegs),
	INIT_PARAMETER(step_roll),
	INIT_PARAMETER(step_pitch),
	INIT_PARAMETER(step_yaw),
  ...
  DECLARE_PARAMETER(double, use_twolegs);
  DECLARE_PARAMETER(double, step_roll);
  DECLARE_PARAMETER(double, step_pitch);
  DECLARE_PARAMETER(double, step_yaw);
