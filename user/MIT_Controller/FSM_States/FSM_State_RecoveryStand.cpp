  ...
  switch ((int)this->_data->controlParameters->control_mode) {
     case K_RECOVERY_STAND:
      ...
      // Normal operation for state based transitions
       //this->_data->controlParameters->control_mode = 2.0;
       //this->nextStateName = FSM_StateName::BALANCE_STANDVBL;
       this->nextStateName = FSM_StateName::STAND_UP;
       // Notify the control parameters of the mode switch
       //this->_data->controlParameters->control_mode = K_BALANCE_STAND_VBL;
      break;
...
TransitionData<T> FSM_State_RecoveryStand<T>::transition() {
  ...
  switch (this->nextStateName) {
    ...
    case FSM_StateName::BALANCE_STANDVBL:
      this->transitionData.done = true;
      break;
