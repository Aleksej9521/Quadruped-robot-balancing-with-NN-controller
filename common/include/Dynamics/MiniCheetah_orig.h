...
Quadruped<T> buildMiniCheetah() {
  ...
  float modMass = 1;//cheetah.param_user->set_ModMass;
  ...
  SpatialInertia<T> abadInertia(0.54*modMass, abadCOM, abadRotationalInertia);
  ...
  SpatialInertia<T> kneeInertia(0.064*modMass, kneeCOM, kneeRotationalInertia);
