...
Quadruped<T> buildMiniCheetah() {
 ...
 float modMass = 1.0;
  ...
  SpatialInertia<T> abadInertia0(0.54*modMass, abadCOM, abadRotationalInertia);
  ...
  SpatialInertia<T> hipInertia0(0.634*modMass, hipCOM, hipRotationalInertia);
  ...
  SpatialInertia<T> kneeInertia0(0.064*modMass, kneeCOM, kneeRotationalInertia);
  ...
  //modMass inertia
  cheetah._abadInertia0 = abadInertia0;
  cheetah._hipInertia0 = hipInertia0;
  cheetah._kneeInertia0 = kneeInertia0;
